...
import { Ranking } from "@/components/products/products"
  ...
  return (
    <div className="container mx-auto py-10 px-5">
      <div className="flex flex-col gap-1 pb-11">
        <h1 className="text-3xl font-semibold">Let's find the most popular products!</h1>
        <p className="text-neutral-400">These products have received excellent reviews on Prodfind.</p>
      ...
      <Suspense fallback={
        ...
        <Ranking initialProducts={products} autoFocus />
      </Suspense>
    </div >
  )
}
